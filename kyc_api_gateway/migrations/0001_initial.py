# Generated by Django 5.2 on 2025-09-30 07:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_by', models.IntegerField(blank=True, null=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('supported_vendors', models.ManyToManyField(related_name='supported_apis', to='kyc_api_gateway.vendormanagement')),
                ('vendor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='default_apis', to='kyc_api_gateway.vendormanagement')),
            ],
            options={
