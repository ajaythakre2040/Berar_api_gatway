# Generated by Django 5.2 on 2025-09-30 13:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone', models.CharField(blank=True, default='UTC', max_length=255, null=True)),
                ...
                ('department', models.ForeignKey(blank=True, db_column='department_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='department_role', to='auth_system.department')),
                ('role_id', models.ForeignKey(blank=True, db_column='role_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users_role', to='auth_system.role')),
            ],
            options={
                'verbose_name': 'User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_by', models.IntegerField(blank=True, default=0, null=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('menu_id', models.ForeignKey(db_column='menu_id', on_delete=django.db.models.deletion.CASCADE, related_name='role_permissions', to='auth_system.menu')),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(condition=models.Q(('deleted_at__isnull', True)), fields=['role_id', 'menu_id'], name='unique_role_menu_active')],
            },
        ),
    ]
